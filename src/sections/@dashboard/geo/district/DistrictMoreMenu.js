...
export default function UserMoreMenu({ value }) {
  ...
  const deleteProvince = async () => {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: 'คุณต้องการลบตำบลนี้ออกหรือไม่ !',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        Swal.fire({
          icon: 'success',
          title: 'คุณได้ลบตำบลนี้ออกเเล้ว',
          showConfirmButton: false,
          timer: 1500,
        });
        await axios.delete(`${process.env.REACT_APP_WEB_GEO_BACKEND}/district/${value.district_id}`, {
          data,
        });
        setTimeout(() => {
    ...
    <>
      ...
      >
        ...
        <MenuItem
          ...
          to="/dashboard/geo/edit-district"
